import 'package:coffee_app_flutter/data/locals/app_preferences/app_preferences_keys.dart';
import 'package:coffee_app_flutter/utils/device_util.dart';
...
class AppPreferences {
  ...
  Future<void> setCartQuantityData(int quantity) async {
    await SharedPreferencesUtil.putInt(
        AppPreferencesKeys.cartQuantityKey, quantity);
  }

  Future<int?> getCartQuantityData() async {
    final quantity =
        await SharedPreferencesUtil.getInt(AppPreferencesKeys.cartQuantityKey);
    return quantity;
  }
}
