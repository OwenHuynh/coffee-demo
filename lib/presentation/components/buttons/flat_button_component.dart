...
import 'package:coffee_app_flutter/utils/debounce_click_action.dart';
...
class FlatButtonComponent extends StatelessWidget {
  ...
  final EdgeInsets? paddingIconAndText;
      ...
      child: MaterialButton(
        ...
        child: Row(
          ...
          children: [
            ...
            Padding(padding: paddingIconAndText ?? EdgeInsets.all(0)),
            textWidget,
          ],
        ),
      ),
